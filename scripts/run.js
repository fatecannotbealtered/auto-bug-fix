...
const toolName = Object.keys(rootPackage.bin || {})[0] || "auto-bug-fix";
...
if (!Object.prototype.hasOwnProperty.call(optionalDependencies, platformPackage)) {
  console.error(
    `${toolName} does not ship an npm platform package for ${platformKey}.\n` +
      "Install on a supported platform (darwin/linux/win32 on x64/arm64), " +
      "or build from source with `go build`."
  );
  process.exit(1);
}
